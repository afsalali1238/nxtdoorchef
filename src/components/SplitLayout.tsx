...
export default function SplitLayout({
  ...
  return (
    <div className="flex flex-col lg:flex-row h-[calc(100vh-62px)] mt-nav">
      {/* Left: scrollable cards panel */}
      <div className="w-full lg:w-[420px] h-[50vh] lg:h-full flex-shrink-0 flex flex-col bg-cream overflow-hidden">
