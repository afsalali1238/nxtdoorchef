...
interface DishCardProps {
  dish: Omit<Dish, 'chefs'> & { chefs?: Pick<Chef, 'id' | 'name' | 'area' | 'whatsapp' | 'photo_url' | 'specialty'> }
  selected?: boolean
  onClick?: () => void
}
...
export default function DishCard({ dish, selected, onClick }: DishCardProps) {
  const chef = dish.chefs as Pick<Chef, 'id' | 'name' | 'area' | 'whatsapp' | 'photo_url' | 'specialty'> | undefined
